            ...
            <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @php
                       $getdata = DB::table('hours')->where('kto', $username)->select(DB::raw("SEC_TO_TIME( SUM( TIME_TO_SEC(total))) as suma"))->value('suma');
                    @endphp
                    ...
                    <td style="display: flex; justify-content: center; items-align: center;">
                        ...
                        <form action="{{ url('/panel') . "/" . $user->id }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger" style="height: 25px; display: flex; justify-content: center; align-items: center;">Usuń</button>
