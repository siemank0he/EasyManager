...
<div class="container" style="margin-top: 70px;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-center">{{ __('Zmiana hasła') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.edit') }}">
                        ...
                        <div class="form-group row">
                            <label for="oldPassword" class="col-md-4 col-form-label text-md-right">{{ __('Obecne hasło') }}</label>
